...
const suggestCustomLoggerRule = {
    defaultOptions: [],
    meta: {
        type: "suggestion",
        messages: {
            customLoggerNotUsedForLog: "Log를 위해 customLogger가 사용되지 않았습니다.",
            customLoggerNotUsedForError: "Error Log를 위해 customLogger가 사용되지 않았습니다.",
        },
        fixable: "code",
        schema: [],
    },
